...
class Builder final : public CBaseVisitor {
    ...
    std::any visitIncludeHeader(CParser::IncludeHeaderContext* context) override;
    std::any visitFunctionDefine(CParser::FunctionDefineContext* context) override;
    std::any visitGlobalInitializing(CParser::GlobalInitializingContext* context) override;
    std::any visitAnyType(CParser::AnyTypeContext* context) override;
    std::any visitVarDeclaration(CParser::VarDeclarationContext* context) override;
    ...
    std::any visitSubscriptExpr(CParser::SubscriptExprContext* context) override;
    ...
    std::any visitAssignmentExpr(CParser::AssignmentExprContext* context) override;
